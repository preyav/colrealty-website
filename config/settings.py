...
INSTALLED_APPS = [
    ...
    # template filters: intcomma, naturaltime, etc.
    ...
    # Third-party
    # Stores Celery task results in the DB (visible in admin)
...
if AWS_STORAGE_BUCKET_NAME:
    ...
    # serve static/media as plain public URLs, no signed tokens
...
# one task at a time per worker — important for long tasks
